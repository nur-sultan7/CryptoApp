...
import com.nursultan.cryptoapp.presentation.CoinFavViewModel
...
interface ViewModelModule {
    ...
    @IntoMap
    @Binds
    @ViewModelKey(CoinFavViewModel::class)
    fun bindCoinFavModel(coinFavViewModel: CoinFavViewModel): ViewModel
